...
class HeaderArrayObj(object):
    ...
    def HeaderArrayFromData(array: np.ndarray, coeff_name: str = None, long_name: str = None,
                            sets: 'List[str]' = None, setElDict: 'Dict[str:List[str]]' = None, dtype = None) -> 'HeaderArrayObj':
        """
        ...
        HeaderArrayObj._setHeaderBaseData(array, coeff_name, hao, long_name, dtype)
        if sets is None:
    ...
    def HeaderArrayFromCompiledData(array: np.ndarray, coeff_name: str=None, long_name: str=None,
                            SetDims: _HeaderDims=None, dtype=None) -> 'HeaderArrayObj':
        """
    ...
    @staticmethod
    def _setHeaderBaseData(array, coeff_name, hao, long_name, dtype) -> None:
