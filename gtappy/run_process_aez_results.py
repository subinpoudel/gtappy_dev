...
if __name__ == '__main__':
    ...
    p.pnas_reslease_with_results_dir = '../gtap_invest/gtap_invest_dev/gtap_invest/gtap_aez/PNAS-Final-Release-with-Results/results/res'

    p.file_extensions_to_extract = [
        "trad.csv",
        "trda.csv",
        "enda.csv",
        "ends.csv",
